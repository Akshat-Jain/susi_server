...
public class BahnService {
  ...
  public static class NoStationFoundException
    extends Exception {
  ...
  public SusiThought getConnections(String from, String to)
    throws
      IOException,
      NoStationFoundException {
  ...
  public SusiThought getConnections(
    String from,
    String to,
    int hoursDep,
    int minutesDep
    ...
    QueryTripsResult tripsResult = provider.queryTrips(
      fromLocations.get(0),
      null,
      toLocations.get(0),
      date,
