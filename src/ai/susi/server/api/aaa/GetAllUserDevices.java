 ...
 */
public class GetAllUserDevices extends AbstractAPIHandler implements APIHandler {
    /**
     * 
     */
    private static final long serialVersionUID = -6147675063044889074L;

    @Override
    public String getAPIPath() {
        return "/aaa/getAllUserDevices.json";
    }
    ...
    public ServiceResponse serviceImpl(Query call, HttpServletResponse response, Authorization rights, final JsonObjectWithDefault permissions) throws APIException {
        ...
        if (call.get("getUserCount", false) == true) {
            ...
            try {
                ...
                result.put("accepted", true);
                result.put("message", "Success: Fetched all Users with their devices!");
                return new ServiceResponse(result);
            } catch (Exception e) {
