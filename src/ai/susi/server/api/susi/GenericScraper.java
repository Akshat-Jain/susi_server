...
public class GenericScraper
  ...
  /**
     ...
     */
  public JSONObject articleAPI(String url, JSONObject genericScraperData)
    throws
  ...
  protected void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    if ("article".equals(type)) {
      ...
      genericScraperData.put(
        "error",
        "Please mentione type of scraper: <article>"
      );
      printJSON(response, genericScraperData);
    }
