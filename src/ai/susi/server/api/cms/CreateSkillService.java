      ...
      if (imagePart == null) {
        ...
        if (userId != null) {
          ...
          if (image_name == null) {
            ...
            json.put(
              "message",
              "The Image name are not given or Image with same name is already present "
            );
          } else {
            ...
            if (skill.exists()) {
              ...
              ImageIO.write(
                bi,
                "jpg",
                new File(imagePath + File.separator + image_name)
              );
              ...
              try (FileWriter Skillfile = new FileWriter(skill)){
                ...
                String path = null;
                if (privateSkill != null) {
                  path = skill.getPath().replace(
                    private_skill_dir.toString(),
                    "users"
                  );
                } else {
                  path = skill.getPath().replace(
                    DAO.model_watch_dir.toString(),
                    "models"
                  );
                }
              } catch(IOException e) {
