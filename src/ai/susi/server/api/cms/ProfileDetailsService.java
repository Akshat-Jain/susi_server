        ...
        for (String language_name : languagenameKeysList) {
          ...
          for (String skill_name : skillnamesKeysList) {
            ...
            for (int i = 0; i < skillnameArray.length(); i++) {
              String jsonEmail = skillnameArray.getJSONObject(i).get(
                "email"
              ).toString();
              if (jsonEmail.equals(email)) {
                ...
                int stars = Integer.parseInt(
                  skillnameArray.getJSONObject(i).get("stars").toString()
                );
                String timestamp = skillnameArray.getJSONObject(i).get(
                  "timestamp"
                ).toString();
