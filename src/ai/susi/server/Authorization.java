...
public class Authorization {
  ...
  public Authorization(
    ...
    if (parent != null) {
      ...
      if (this.json == null && identity.isUuid())
      for (String key : this.parent.keys()) {
    ...
    if (!this.json.has("permissions"))
    this.json.put("permissions", new JSONObject());
