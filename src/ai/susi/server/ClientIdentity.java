...
public class ClientIdentity
  ...
  public enum Type {
    ...
    uuid(true),
    // non-anonymous identity, computed from the (first) email address as md5
    email(true),
  ...
  // anonymous identity users which do not authentify; they are identified by their host name
