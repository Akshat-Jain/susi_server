...
public class ServiceResponse {
  ...
  public JSONObject getObject() throws JSONException {
    ...
    throw new JSONException(
      "object type is not JSONObject: " + this.object.getClass().getName()
    );
  ...
  public JSONArray getArray() throws JSONException {
    if (!isArray())
    throw new JSONException(
      "object type is not JSONArray: " + this.object.getClass().getName()
    );
  ...
  public String getString() throws JSONException {
    if (!isString())
    throw new JSONException(
      "object type is not String: " + this.object.getClass().getName()
    );
  ...
  public byte[] getByteArray() throws JSONException {
    if (!isByteArray())
    throw new JSONException(
      "object type is not ByteArray: " + this.object.getClass().getName()
    );
  ...
  public String toString(boolean minified) {
    if (isObject())
    return getObject().toString(minified ? 0 : 2);
    if (isArray())
    return getArray().toString(minified ? 0 : 2);
    if (isString())
    return getString();
    if (isByteArray())
  ...
  public byte[] toByteArray(boolean minified) {
    if (isObject())
    return getObject().toString(minified ? 0 : 2).getBytes(
      StandardCharsets.UTF_8
    );
    if (isArray())
    return getArray().toString(minified ? 0 : 2).getBytes(
      StandardCharsets.UTF_8
    );
    if (isString())
