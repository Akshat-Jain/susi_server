...
public class JsonFile
  ...
  public void updateToFile() throws JSONException {
    if (this.file.lastModified() == this.file_date)
    return;
    JSONObject json;
    try {
  ...
  @Override
  public synchronized JSONObject put(String key, double value)
    throws
      JSONException {
    updateToFile();
    super.put(key, value);
  ...
  @Override
  public synchronized JSONObject put(String key, Collection<?> value)
    throws
      JSONException {
    updateToFile();
    super.put(key, value);
  ...
  @Override
  public synchronized JSONObject put(String key, int value)
    throws
      JSONException {
    updateToFile();
    super.put(key, value);
  ...
  @Override
  public synchronized JSONObject put(String key, long value)
    throws
      JSONException {
    updateToFile();
    super.put(key, value);
  ...
  @Override
  public synchronized JSONObject put(String key, Map<?, ?> value)
    throws
      JSONException {
    updateToFile();
    super.put(key, value);
  ...
  public synchronized JSONObject put(String key, JSONObject value)
    throws
      JSONException {
    updateToFile();
    super.put(key, value);
