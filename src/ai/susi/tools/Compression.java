...
public class Compression {
  ...
  public static void gzip(File source, File dest, boolean deleteSource)
    throws
      IOException {
    byte[] buffer = new byte[2 ^ 20];
    GZIPOutputStream out = new GZIPOutputStream(
      new BufferedOutputStream(new FileOutputStream(dest), 65536)
    ) {
  ...
  public static void gunzip(File source, File dest, boolean deleteSource)
    throws
      IOException {
    byte[] buffer = new byte[2 ^ 20];
