...
public interface GeoPoint {
  public static final double meter = 90.0d / 1.0e7d;


  // this is actually the definition of 'meter': 10 million meter shall be the distance from the equator to the pole
