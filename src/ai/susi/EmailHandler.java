...
public class EmailHandler {
  ...
  public static void sendEmail(
    ...
    boolean disableCertChecking = DAO.getConfig(
      "smtp.trustselfsignedcerts",
      false
    );
    ...
    message.setReplyTo(
      new Address[] { new InternetAddress(senderEmail, displayname) }
    );
  ...
  /**
     ...
     * @throws MessagingException on error
     */
  static private Properties createProperties(
    @Nonnull
    String hostname,
    int port,
    @Nonnull
    ...
    throws
      MessagingException {
    if (port <= 0 || port > 65535 || !("none".equals(
      encryption
    ) || "tls".equals(encryption) || "starttls".equals(encryption))) {
